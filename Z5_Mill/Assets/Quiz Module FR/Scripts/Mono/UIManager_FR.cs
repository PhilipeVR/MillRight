...
[Serializable()]
public struct SolutionUIElements_FR
{
...
[Serializable()]
public struct UIManagerParameters_FR
{
...
public class UIManager_FR : MonoBehaviour {
    ...
    [SerializeField]    AnswerData_FR             answerPrefab                 = null;

    [SerializeField]    UIElements_FR             uIElements                   = new UIElements_FR();

    [Space]
    [SerializeField]    UIManagerParameters_FR    parameters                   = new UIManagerParameters_FR();

    private             List<AnswerData_FR>       currentAnswers               = new List<AnswerData_FR>();
    ...
    [Space]
    [SerializeField]    SolutionUIElements_FR     solutionUIElements                   = new SolutionUIElements_FR();
    ...
    void UpdateQuestionUI(Question_FR question)
    {
    ...
    public void UpdateSolutionUI(Question_FR question)
    {
    ...
    {
        yield return new WaitForSeconds(GameUtility_FR.ResolutionDelayTime);
    ...
    {
        var highscore = PlayerPrefs.GetInt(GameUtility_FR.SavePrefKey);
    ...
    void CreateAnswers(Question_FR question)
    {
        EraseAnswers();
        ...
        {
            AnswerData_FR newAnswer = (AnswerData_FR)Instantiate(answerPrefab, uIElements.AnswersContentArea);
