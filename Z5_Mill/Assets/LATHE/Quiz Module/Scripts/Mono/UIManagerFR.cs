...
[Serializable()]
public struct SolutionUIElementsFR
{
...
[Serializable()]
public struct UIManagerParametersFR
{
...
public class UIManagerFR : MonoBehaviour {
    ...
    [SerializeField]    AnswerDataFR             answerPrefab                 = null;

    [SerializeField]    UIElementsFR             uIElements                   = new UIElementsFR();

    [Space]
    [SerializeField]    UIManagerParametersFR    parameters                   = new UIManagerParametersFR();

    private             List<AnswerDataFR>       currentAnswers               = new List<AnswerDataFR>();
    ...
    [Space]
    [SerializeField]    SolutionUIElementsFR     solutionUIElements                   = new SolutionUIElementsFR();
    ...
    void UpdateQuestionUI(QuestionFR question)
    {
    ...
    public void UpdateSolutionUI(QuestionFR question)
    {
    ...
    void CreateAnswers(QuestionFR question)
    {
        EraseAnswers();
        ...
        {
            AnswerDataFR newAnswer = (AnswerDataFR)Instantiate(answerPrefab, uIElements.AnswersContentArea);
